...
//      System.out.print("parsing " + currentPath + " ");
   ...
   private void AddErrorListener(Lexer lexer, Parser parser){
	...
	public String OutputVlanInstanceCount(String prefix){
      String vlanInstanceCount = "";
      if(vendor.startsWith("Cisco")){
         CiscoGrammar cisco = (CiscoGrammar)parser;
         vlanInstanceCount = prefix+cisco.OutputVlanInstance()+"\n";
      }
      else if(vendor.startsWith("Arista")){
         AristaGrammar arista = (AristaGrammar) parser;
      }
      ...
      return vlanInstanceCount;
	}

   public String OutputVlans(String prefix){
      String out = "";
      if(vendor.startsWith("Cisco")){
         CiscoGrammar cisco = (CiscoGrammar)parser;
         out = prefix+cisco.OutputVlans()+"\n";
      }
      else if(vendor.startsWith("Arista")){
         AristaGrammar arista = (AristaGrammar) parser;
      }
   ...
   public String OutputIfaceRanges(String prefix){
      ...
      if(vendor.startsWith("Cisco")){
         CiscoGrammar cisco = (CiscoGrammar)parser;
         out = cisco.OutputIfaceVlans(prefix);
      }
      else if(vendor.startsWith("Arista")){
         AristaGrammar arista = (AristaGrammar) parser;
      }
